...
type DatabaseStatsChartsProps = {
  statsPromise: Promise<DatabaseStats>;
};

export default function DatabaseStatsCharts({
  statsPromise,
}: DatabaseStatsChartsProps) {
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0 min-h-0 min-w-0">
